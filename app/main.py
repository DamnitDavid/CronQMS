...
from app.api.routes import account, admin, admin_pages, admin_roles, alerts, attachments, audit_log, audit_pages, audits, auth, capas, change_pages, changes, comments, document_pages, documents, events, pages, reports, setup, training, training_pages, users
